<x-app-layout>
                    ...
                    <form action="{{ route('villa-pricing.store') }}" method="POST" id="pricing-form">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
                                <div>
                                    ...
                                    <input type="number" name="sunday_pricing" id="sunday_pricing" min="0"
                                        step="1000" value="{{ old('sunday_pricing') }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                <div>
                                    ...
                                    <input type="number" name="monday_pricing" id="monday_pricing" min="0"
                                        step="1000" value="{{ old('monday_pricing') }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                <div>
                                    ...
                                    <input type="number" name="tuesday_pricing" id="tuesday_pricing" min="0"
                                        step="1000" value="{{ old('tuesday_pricing') }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                <div>
                                    ...
                                    <input type="number" name="wednesday_pricing" id="wednesday_pricing" min="0"
                                        step="1000" value="{{ old('wednesday_pricing') }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                <div>
                                    ...
                                    <input type="number" name="thursday_pricing" id="thursday_pricing" min="0"
                                        step="1000" value="{{ old('thursday_pricing') }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                <div>
                                    ...
                                    <input type="number" name="friday_pricing" id="friday_pricing" min="0"
                                        step="1000" value="{{ old('friday_pricing') }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                <div>
                                    ...
                                    <input type="number" name="saturday_pricing" id="saturday_pricing" min="0"
                                        step="1000" value="{{ old('saturday_pricing') }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg mb-6">
                            ...
                            <div id="range-date-prices-container">
                                <!-- Dynamic range date prices will be added here -->
                            </div>
                        </div>
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg mb-6">
                            ...
                            <div id="special-price-ranges-container">
                                <!-- Dynamic special price ranges will be added here -->
                            </div>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Show special price fields if checked on page load
            if (useSpecialPrice.checked) {
                specialPriceFields.style.display = 'grid';
            }
