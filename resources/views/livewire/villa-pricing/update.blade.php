<div>
    ...
    <x-dialog-modal wire:model="open">
        ...
        <x-slot name="content">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select wire:model.defer="season_id" class="w-full border-gray-300 rounded-md shadow-sm">
        ...
        <x-slot name="footer">
            <x-button wire:click="update" class="bg-blue-600 hover:bg-blue-700 text-white">Simpan</x-button>
